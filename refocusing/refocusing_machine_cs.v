...
Module Type REF_EVAL_APPLY_MACHINE (R : RED_REF_SEM) <: DET_ABSTRACT_MACHINE.
  ...
  | t_cterm :                                  forall {k k'} (ec : elem_context_kinded k k') (c : context ick k) v t {k''} (ec0 : elem_context_kinded k k''),
  ...
  Definition dnext_conf (st : configuration) : option configuration :=
      ...
      | @c_eval t k c  => 
            ...
            | in_red r     => option_map (fun t' => c_eval t' c) (contract r c)
